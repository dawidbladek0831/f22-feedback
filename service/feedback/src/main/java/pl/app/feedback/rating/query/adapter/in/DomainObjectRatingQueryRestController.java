...
@RestController
@RequestMapping(DomainObjectRatingQueryRestController.resourcePath)
@RequiredArgsConstructor
class DomainObjectRatingQueryRestController {
    ...
    @GetMapping
    Mono<ResponseEntity<DomainObjectRating>> fetchBy(
